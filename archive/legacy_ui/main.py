...
from backend.services.get_gtin import lookup_gtin, lookup_by_gtin
...
from archive.legacy_ui.session_manager import SessionManager
from backend.services.utils import get_tnved_code, save_snapshot, save_order_history
...
from backend.services.get_thumb import get_thumbprint
from backend.services.history_db import OrderHistoryDB
from backend.services.bartender_print import (
    BarTenderPrintError,
    build_print_context,
    list_installed_printers,
    print_labels,
)
from backend.services.bartender_label_100x180 import (
...
from backend.kontur.cryptopro import find_certificate_by_thumbprint, sign_data, sign_text_data
...
class App(ctk.CTk):
    ...
    def _intro_worker(self, item: dict, production_patch: dict, thumbprint: str | None):
        ...
        try:
            ...
            from backend.kontur.api import put_into_circulation
        ...
        try:
            ...
            try:
                ...
                if ok:
                    ...
                    from backend.kontur.api import mark_order_as_tsd_created
