...
mainScript = fso.BuildPath(fso.BuildPath(projectDir, "ui_v2"), "server_only.py")
...
ElseIf fso.FileExists(python) Then
    ...
    shell.Run cmd, 0, False
Else
    MsgBox "Не найдена установленная среда Kontur API (.venv). Запустите setup.bat заново.", vbExclamation, "CRPT server"
End If
