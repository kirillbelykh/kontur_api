...
$singleShortcut = $env:KONTUR_INSTALL_SINGLE_SHORTCUT -eq "1"
foreach ($legacy in @("KonturAPI", "KonturTestAPI", "KonturMobile", "CRPT server", "KonturAccessProlongation")) {
    Remove-DesktopShortcut -ShortcutName $legacy
}

# Desktop shortcut: "Контур Маркировка"
Create-DesktopShortcut `
    -ProjectDir $projectDir `
...
Write-Host "Run the app from desktop shortcut: Kontur Markirovka"
